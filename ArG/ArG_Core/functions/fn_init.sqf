...
B_Safe_trg setTriggerStatements ["this","[]execVM  'ArG_Core\functions\fn_Safty.sqf'"];
...
R_Safe_trg setTriggerStatements ["this","[]execVM  'ArG_Core\functions\fn_Safty.sqf'"];
...
G_Safe_trg setTriggerStatements ["this","[]execVM  'ArG_Core\functions\fn_Safty.sqf'"];
