...
class  Land_SatellitePhone_F;
    ...
    class ArG_BuzzerBox:  Land_SatellitePhone_F
  {
    ...
    hiddenSelectionsTextures[] = {};
      ...
      class EventHandlers
          {
               init = "Rodeo = [(_this select 0),'Time Counter','\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_connect_ca.paa','\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_hack_ca.paa','(_this getvariable '_Hited' == 0)','true',{missionNamespace setVariable ['Buzz',2,true];},{_target say3D 'Click'},{[]execVM 'ArG_Core\functions\fn_BuzzerBox.sqf'},{},[],5,0,false,false] call BIS_fnc_holdActionAdd;";
          };
    };
