    ...
    class ArG_BuzzerBox:  Land_SatellitePhone_F
{
    ...
    hiddenSelectionsTextures[] = {};
      ...
      class EventHandlers
          {
               init = "[(_this select 0),'Time Counter','\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_connect_ca.paa','\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_hack_ca.paa','_this distance _target < 3','_caller distance _target < 3',{},{},{[]execVM  'ArG_Core\functions\fn_BuzzerBox.sqf'},{missionNamespace setVariable ['Buzz',2,true];systemChat'Wait';},[],2,0,false,false] call BIS_fnc_holdActionAdd;";
