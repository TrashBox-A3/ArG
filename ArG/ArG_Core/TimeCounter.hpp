    ...
    class ArG_BuzzerBox:  Land_SatellitePhone_F
{
    ...
    hiddenSelectionsTextures[] = {};
      ...
      class EventHandlers
          {
               init = "0=[(_this select 0),'Time Counter','\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_connect_ca.paa','\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_hack_ca.paa','true','true',{missionNamespace setVariable ['Buzz',2,true];},{},{[]execVM 'ArG_Core\functions\fn_BuzzerBox.sqf'},{},[],10,0,false,false] call BIS_fnc_holdActionAdd;";
