class cfgMagazines
{
    ...
    {
    	author="Rodeostar42";
		displayName = "520Rnd 556x45 6mmBB";
		scope = 2;
    ...
    {
    	author="Rodeostar42";
		displayName = "82Rnd 556x45 6mmBB";
		scope = 2;
		ammo = ArG_6mm_BB_02; //eg
		count = 82;
		initSpeed = 100; // in case it is not in weapon
    ...
    {
    	author="Rodeostar42";
		displayName = "30Rnd Top 6mmBB";
		scope = 2;
		ammo = ArG_6mm_BB_02_TOP; //eg
		count = 30;
		initSpeed = 100; // in case it is not in weapon
		tracersEvery=1;
		class ItemInfo
	...
	class ArG_90Rnd_762x51_BB: rhsusf_20Rnd_762x51_m118_special_Mag
    {
    	author="Rodeostar42";
		displayName = "90Rnd 6mmBB";
		scope = 2;
		ammo = ArG_6mm_BB_02; //eg
		count = 90;
		initSpeed = 100; // in case it is not in weapon
